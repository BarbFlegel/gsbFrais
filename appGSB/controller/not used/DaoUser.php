...
class DaoUser{
    ...
    private function __construct(){
         DaoUser::$monPdo = new PDO(DaoUser::$serveur.';'.DaoUser::$bdd, DaoUser::$user, DaoUser::$mdp);
    ...
    public  static function getPdoGsb(){
        ...
        if(DaoUser::$monPdoGsb==null){
            DaoUser::$monPdoGsb= new DaoUser();
        }
        return DaoUser::$monPdoGsb;
    }
...
/*     public function ajouterUser(User $user){
    ...
    /* public function ajouterUser(User $user){
        ...
        $req = "insert into user(nom,prenom,datenaissance,login,password,email)  values (:nom,:prenom,:datenaissance,:login,:password,:email)";
        try{
        $stmt = DaoUser::$monPdo->prepare($req);
